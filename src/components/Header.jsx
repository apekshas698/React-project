...
const Header = () => {
  return (
    <div className='min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden' style={{backgroundImage:"url('https://wallpapercave.com/wp/wp4110657.jpg')"}} id='Header'>
    <Navbar/>
    <motion.div 
